  ...
  const navItems = [
    {
      ...
      activeBg: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/40 shadow-emerald-950/40',
    },
    {
      id: 2 as const,
      ...
      icon: Boxes,
      accent: 'text-sky-400',
      activeBg: 'bg-sky-500/20 text-sky-300 border-sky-500/40 shadow-sky-950/40',
    },
    {
      id: 4 as const,
      ...
      activeBg: 'bg-teal-500/20 text-teal-300 border-teal-500/40 shadow-teal-950/40',
    },
    {
      id: 5 as const,
      ...
      activeBg: 'bg-purple-500/20 text-purple-300 border-purple-500/40 shadow-purple-950/40',
  ...
  return (
    <>
      ...
      <nav
        ...
        className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-slate-950/95 backdrop-blur-2xl border-t border-slate-800/90 px-2 py-1.5 pb-[max(0.6rem,env(safe-area-inset-bottom))]"
      >
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex-1 py-1.5 px-1 min-h-[48px] rounded-2xl flex flex-col items-center justify-center gap-0.5 transition-all duration-150 cursor-pointer relative active:scale-90 ${
                  isActive
                    ? `${item.activeBg} font-bold shadow-md border ring-1 ring-white/10`
